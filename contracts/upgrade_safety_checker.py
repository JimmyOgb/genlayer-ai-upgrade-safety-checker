...
class UpgradeSafetyChecker(gl.Contract):
    ...
    def run_audit(self, old_code_cid: str, new_code_cid: str) -> typing.Any:
        ...
        def get_audit_result() -> typing.Any:
            ...
            task = f"""You are an ultra-conservative Web3 Security Oracle.
Compare the two smart-contract versions below and detect if upgrading introduces security regressions.
=== OLD CONTRACT ===
{old_code}
=== NEW CONTRACT ===
{new_code}
Respond with JSON only:
{{"security_decreased": bool, "risk_level": str, "storage_collision_detected": bool, "findings": list}}
